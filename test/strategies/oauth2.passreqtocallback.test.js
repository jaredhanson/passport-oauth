...
describe('OAuth2Strategy with passReqToCallback option', function() {
  ...
  describe('and params argument in verify callback', function() {
    ...
    var strategy = new OAuth2Strategy({
      ...
      function(req, accessToken, refreshToken, params, profile, done) {
        if (accessToken == '2YotnFZFEjr1zCsicMWpAA' && refreshToken == 'tGzv3JOkF0XG5Qx2TlKWIA' && params.example_parameter == 'example_value' && Object.keys(profile).length == 0) { 
          return done(null, { id: '1234' }, { message: 'Hello', foo: req.headers['x-foo'] });
        }
        return done(null, false);
      });
